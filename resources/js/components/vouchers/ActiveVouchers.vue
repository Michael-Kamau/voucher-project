...
<!--                    <td class="border px-4 py-2">{{voucher.code}}</td>-->
        ...
        <div class="myModal">
            <div>
                ...
                <modal v-on:buy="buyVoucher()" name="buy-modal" @before-open="beforeOpen" :adaptive="true" :height="430" :width="400"
                    ...
                    <form class="w-full max-w-sm p-6">
                        ...
                        <div class="md:flex-row md:items-left mb-6">
                            ...
                            <div class="md:w-2/3">
                                <input
                                    class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                                    id="inline-number" type="text" placeholder="M-Pesa/Bank" v-model="vouchers.transactionCode">
                            </div>
                        </div>
